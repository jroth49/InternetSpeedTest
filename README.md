Automates Internet Speed tests to log speeds at different times. You can use a cron job to schedule the task. If you must pass in 1 or 2 after calling the script, 1 = Check Speed, 2 = Send Email
